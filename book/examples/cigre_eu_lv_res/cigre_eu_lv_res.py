...
if dae_file_mode == 'local':
    import cigre_eu_lv_res_ini_cffi as jacs_ini
    import cigre_eu_lv_res_run_cffi as jacs_run
    import cigre_eu_lv_res_trap_cffi as jacs_trap
