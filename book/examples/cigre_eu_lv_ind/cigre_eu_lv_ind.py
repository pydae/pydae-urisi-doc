...
class model: 
    ...
    def __init__(self): 
        ...
        self.N_z = 32 
        self.N_store = 100000 
        self.params_list = ['g_shunt_I01_3', 'b_shunt_I01_3', 'K_abc_I02', 'X_MV0_s', 'R_MV0_s', 'K_p_agc', 'K_i_agc', 'K_xif'] 
        self.params_values_list  = [0.3333333333333333, 0.0, 1.0, 0.1, 0.01, 0.01, 0.01, 0.01] 
